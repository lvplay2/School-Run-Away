...
public class SimpleProtectCameraFromWallClip : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		m_DefaultDistance = m_OriginalDist;
	}
	...
	public void SetCameraDistance(float ratio)
	{
		m_OriginalDist = m_DefaultDistance * ratio;
	}
}
